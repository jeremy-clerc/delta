...
func TestDelta(t *testing.T) {
	data := []struct {
		...
		{
			a:           time.Date(2019, time.June, 6, 12, 0, 0, 0, time.Local),
			b:           time.Date(2019, time.June, 20, 14, 0, 0, 0, time.Local),
			want:        82,
			wantDay:     14,
			wantWeekend: 2,
			name:        "overmultiweek",
		...
		{
			a:           time.Date(2019, time.June, 6, 12, 0, 0, 0, time.Local),
			b:           time.Date(2019, time.June, 20, 10, 0, 0, 0, time.Local),
			want:        78,
			wantDay:     14,
			wantWeekend: 2,
		...
		{
			a:           time.Date(2019, time.June, 6, 12, 0, 0, 0, time.Local),
			b:           time.Date(2019, time.June, 19, 14, 0, 0, 0, time.Local),
			want:        74,
			wantDay:     13,
			wantWeekend: 2,
		...
		{
			a:           time.Date(2019, time.June, 6, 12, 0, 0, 0, time.Local),
			b:           time.Date(2019, time.June, 21, 14, 0, 0, 0, time.Local),
			want:        90,
			wantDay:     15,
			wantWeekend: 2,
		...
		{
			a:           time.Date(2019, time.June, 6, 12, 0, 0, 0, time.Local),
			b:           time.Date(2019, time.June, 21, 20, 0, 0, 0, time.Local),
			want:        94,
			wantDay:     18,
			wantWeekend: 3,
		...
		{
			a:           time.Date(2019, time.June, 6, 12, 0, 0, 0, time.Local),
			b:           time.Date(2019, time.June, 21, 2, 0, 0, 0, time.Local),
			want:        86,
			wantDay:     15,
			wantWeekend: 2,
		...
		{
			a:           time.Date(2019, time.August, 14, 12, 0, 0, 0, time.Local),
			b:           time.Date(2019, time.August, 16, 14, 0, 0, 0, time.Local),
			want:        10,
			wantDay:     2,
			wantWeekend: 0,
			name:        "holiday",
		...
		{
			a:           time.Date(2019, time.July, 12, 12, 0, 0, 0, time.Local),
			b:           time.Date(2019, time.July, 15, 14, 0, 0, 0, time.Local),
			want:        10,
			wantDay:     3,
			wantWeekend: 1,
